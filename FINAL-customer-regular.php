...
<body>
    ...
    <form action="orderprocess.php" method="post">
        ...
        <div class="bottom-section">
            <div class="form-container">
                ...
                <select id="laundry-service" name="laundryService">
                    <option value="Wash & Dry">Wash & Dry</option>
                    <option value="Wash & Dry & Fold">Wash & Dry & Fold</option>
                    <option value="Wash & Dry & Fold & Ironing">Wash & Dry & Fold & Ironing</option>
                </select>
            ...
            <div class="price-breakdown">
                ...
                <p id="service">Laundry Service: -</p>
                <p id="bar"></p>
    ...
    var prices = {
        '8 KG': { 'Wash & Dry': 130, 'Wash & Dry & Fold': 150, 'Wash & Dry & Fold & Ironing': 250 },
        '12 KG': { 'Wash & Dry': 150, 'Wash & Dry & Fold': 170, 'Wash & Dry & Fold & Ironing': 270 }
    };
    ...
    document.getElementById("service").textContent = "Laundry Service: " + selectedService;
