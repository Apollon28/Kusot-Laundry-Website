...
$dateofdelivery = isset($_POST['dateofdelivery']) ? $_POST['dateofdelivery'] : null;
$laundryWeight = isset($_POST['laundryWeight']) ? $_POST['laundryWeight'] : null;
$clothesType = "Regular"; // New column
$laundromat = isset($_POST['laundromat']) ? $_POST['laundromat'] : null;
$laundryService = "Self-Service";
...
if ($totalprice !== null && $customerName !== null && $address !== null && $contactnumber !== null && $dateofpickup !== null && $dateofdelivery !== null && $laundryWeight !== null && $clothesType !== null && $laundromat !== null && $laundryService !== null) {
    ...
    $stmt->bind_param("sssssssssd", $customerName, $address, $contactnumber, $dateofpickup, $dateofdelivery, $laundryWeight, $clothesType, $laundromat, $laundryService,  $totalprice);
