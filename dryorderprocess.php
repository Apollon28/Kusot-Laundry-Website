...
$dateofpickup = isset($_POST['dateofpickup']) ? $_POST['dateofpickup'] : null; // Changed variable name
$dateofdelivery = isset($_POST['dateofdelivery']) ? $_POST['dateofdelivery'] : null; // Changed variable name
$laundryWeight = isset($_POST['laundryWeight']) ? $_POST['laundryWeight'] : null;
$clothesType = isset($_POST['clothesType']) ? $_POST['clothesType'] : null; // New column
$laundromat = "1";
...
if ($totalprice !== null && $customerName !== null && $address !== null && $contactnumber !== null && $dateofpickup !== null && $dateofdelivery !== null && $laundryWeight !== null && $clothesType !== null && $laundromat !== null && $laundryService !== null) {
    ...
    $stmt->bind_param("sssssssssd", $customerName, $address, $contactnumber, $dateofpickup, $dateofdelivery, $laundryWeight, $clothesType, $laundromat, $laundryService, $totalprice); // Modified line to include Date of Delivery
    ...
    if (!$execval) {
        ...
        if ($updateExecVal) {
            ...
            $_SESSION['orderDetails'] = array(
                ...
                'dateofdelivery' => $dateofdelivery, // Include Date of Delivery in session data
    ...
    echo "Error: Required fields are null. Fields: totalprice=$totalprice, customerName=$customerName, address=$address, contactnumber=$contactnumber, dateofpickup=$dateofpickup, dateofdelivery=$dateofdelivery, laundryWeight=$laundryWeight, clothesType=$clothesType, laundromat=$laundromat, laundryService=$laundryService";
}
?>
